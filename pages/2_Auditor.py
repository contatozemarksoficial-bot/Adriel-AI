...
produto_input = st.text_input("Digite o nome do produto internacional para auditar:", value="Obsesta")
st.write("")
...
if st.button("🚀 EXECUTAR AUDITORIA DE MERCADO"):
    with st.spinner("Conectando aos servidores de leilão e cruzando dados de buscas em tempo real..."):
        ...
        produto_limpo = produto_input.strip().lower()
        ...
        if produto_limpo in produtos_validados_elite:
            ...
            with col_m2:
                st.metric(label="🌍 Melhor País para Anunciar (ROI)", value="Reino Unido 🇬🇧")
            with col_m3:
